...
define('ENABLE_SHELL', env_bool('PANEL_ENABLE_SHELL', false));
...
$defaultUserHash = '$2y$12$lAIGM3vgSoJYYxgVfWukC.0/3gTjQu89ee.m4SeH/NQuu8oNlzv6i';
...
if (empty($_SESSION['authenticated']) || $_SESSION['authenticated'] !== true) {
    ...
    if (isset($_POST['login'])) {
        ...
        } elseif (!$requestIsHttps && !$loopbackRequest && !env_bool('PANEL_ALLOW_INSECURE_HTTP', false)) {
            security_event('login_transport_rejected');
            http_response_code(426);
            $err = 'HTTPS ES OBLIGATORIO PARA AUTENTICARSE';
        } elseif (!$csrfOk) {
